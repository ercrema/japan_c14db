...
```{r}
c14raw$CorrectedC14Age[grep('[^0-9.-]',c14raw$CorrectedC14Age)]=NA
c14raw$CorrectedC14Age=as.numeric(c14raw$CorrectedC14Age)
c14raw$CorrectedC14Error=as.numeric(c14raw$CorrectedC14Error)
...
c14raw$MaterialType = gsub("(^[[:space:]]+|[[:space:]]+$)", "", c14raw$MaterialType)
...
```{r}
# For Analyses
write.csv(c14raw,file='japanc14db_v03.2(210218).csv')
c14db=c14raw
save(c14db,file='japanc14db_v03.2(210218).RData')
...
c14translation = data.frame(LabCode=c14db_fortrans$LabCode,
                            ...
                            CorrectedC14Age=as.numeric(c14db_fortrans$CorrectedC14Age),
                            CorrectedC14AgeError=as.numeric(c14db_fortrans$CorrectedC14Error),
...
save(c14translation,file='japanc14db_translation_v03.2(210218).RData')
write.csv(c14translation,file='japanc14db_translation_v03.2(210218).csv')
```
