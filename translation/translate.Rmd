...
# STEP 9 : Period Code Translation ----

# STEP 10 : Reorganise and export ----
...
c14db  <- select(c14db,LabCode,PrefectureNameEn,Region,SiteNameJp=SiteName,)


c14db  <- select(c14raw,originalRow,LabCode,PrefectureCode,SiteName,SiteLocation,SamplingLocation,MaterialType,MaterialCode1,MaterialCode2,Period,Pahase,PeriodCode,
```
